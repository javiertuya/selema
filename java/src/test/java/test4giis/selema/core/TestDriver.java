...
public class TestDriver {
	...
	public void testHeadlessWebDriverWithOptions() {
		...
		WebDriver driver=factory.getSeleniumDriver("chrome", "", "", caps.unwrap(), chromeHeadlesArgument, null);
	...
	public void testRemoteWebDriverFromManagerNoBrowserService() {
		...
		SeleManager sm=new SeleManager(Config4test.getConfig())
				...
				.setOptions(capsToAdd.unwrap()); //can't get options from driver instance, check at the debug log
